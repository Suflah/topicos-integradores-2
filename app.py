...
def init_db():
    # inicializa o banco (cria arquivo se necessário)
...
app = Flask(__name__)
# se quiser usar secret key para sessões ou CSRF, defina aqui:
...
# inicializa o banco ao importar (prático para dev/avaliação)
init_db()
...
if __name__ == '__main__':
    # em produção use um servidor WSGI (gunicorn/uwsgi). Aqui deixamos host padrão (127.0.0.1).
    app.run()
